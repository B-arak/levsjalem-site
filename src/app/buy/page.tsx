...
const faqs = [
  ...
  {
    q: "אני גרוש/ה כבר שנה — האם הספר עדיין רלוונטי?",
    a: "בהחלט. הספר מתאים לכל מי שנמצא בין חודש לשנתיים מהפרידה. לפעמים הכי קשה זה לא מיד אחרי — אלא בדיוק כשהאדרנלין שוכך והכאב האמיתי עולה לפני.",
  },
  {
    q: "מה אם הספר לא יעזור לי?",
    a: "אם קראת את הספר ולא קיבלת ממנו שום ערך — כתוב לי ישירות לbarakuty@gmail.com. אני אישית אדאג שתצא מרוצה. אני לא מוכר אוויר.",
  },
  {
        ...
        <section className="py-24 md:py-32" style={{ background: "#fafaf8" }}>
          <div className="container-narrow">
            <div className="max-w-2xl mx-auto">
              ...
              >
                אם הגעת לכאן, כנראה שאתה מכיר את זה...
              </h2>
              <p className="text-base mb-10" style={{ color: "var(--color-text-muted)" }}>
                לא צריך להסביר לי. אני מכיר.
              </p>

              <ul className="space-y-4">
                {[
                  "אתה מתעורר כל בוקר עם אותה תחושת כובד — ויודע שהיא תישאר לפחות עד הצהריים.",
                  'אתה מרגיש כעס שמנהל אותך. גם כשלא רצית. "כבר שחררתי" — אבל זה חוזר.',
                  "הבדידות פוגעת דווקא ברגעים הכי לא צפויים. בסופרמרקט. בפקק. בסוף שבת.",
                  "אתה לא יודע מה להגיד לילדים. לחברים. ואפילו לעצמך.",
                  "הביטחון העצמי שהיה לך — איבדת אותו בדרך. ואתה לא בטוח איפה לחפש.",
                  "יש ימים שנראה קדימה. ויש ימים שהכל כבד מנשוא. ולא יודע מתי יגיע הבא.",
                  '"תעבור הלאה" — כולם אומרים. אף אחד לא מסביר איך.',
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-4">
                    <span
                      className="mt-0.5 shrink-0 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold"
                      style={{ background: "#eaf1ec", color: "#2d5043" }}
                    >
                      ✓
                    </span>
                    <span
              ...
              >
                <p
                  className="font-[family-name:var(--font-display)] text-xl md:text-2xl leading-relaxed"
                  style={{ color: "var(--color-text)" }}
                >
                  זה לא אומר שאתה חלש.{" "}
                  <span style={{ color: "#2d5043", fontWeight: "bold" }}>
                    זה אומר שאתה עובר את אחד הדברים הכי קשים שיש.
                  </span>
                  <br />
                  <span className="text-lg" style={{ color: "var(--color-text-muted)" }}>
                    ואתה לא חייב לעבור אותו לבד.
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
              ...
              <div>
                ...
                >
                  ...
                  <p>
                    היום אני בן 43, אבא לשלושה, נשוי בשנית ובונה חיים שאני גאה
